...
namespace HotFix.Test.core.field
{
    ...
    public class checking_the_value_for_integer_equality
    {
        ...
        {
            var field = new Field("34=XXXXX\u0001", 0, new Segment(3, 5), 9, 0);
        ...
        {
            var field = new Field("34=54321\u0001", 0, new Segment(3, 5), 9, 0);
        ...
        {
            var field = new Field("34=12345\u0001", 0, new Segment(3, 5), 9, 0);
