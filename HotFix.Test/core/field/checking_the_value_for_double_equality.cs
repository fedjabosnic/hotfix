...
namespace HotFix.Test.core.field
{
    ...
    public class checking_the_value_for_double_equality
    {
        ...
        {
            var field = new Field("34=XXXXXX\u0001", 0, new Segment(3, 6), 10, 0);
        ...
        {
            var field = new Field("34=543.21\u0001", 0, new Segment(3, 6), 10, 0);
        ...
        {
            var field = new Field("34=123.45\u0001", 0, new Segment(3, 6), 10, 0);
