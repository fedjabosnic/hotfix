...
namespace HotFix.Test.core.field
{
    ...
    public class checking_the_value_for_datetime_equality
    {
        ...
        {
            var field = new Field("34=XXXXXX-YY:YY:YY.ZZZ\u0001", 0, new Segment(3, 21), 25, 0);
        ...
        {
            var field = new Field("34=20170423-12:32:23.123\u0001", 0, new Segment(3, 21), 25, 0);
        ...
        {
            var field = new Field("34=20170327-09:34:21.456\u0001", 0, new Segment(3, 21), 25, 0);
